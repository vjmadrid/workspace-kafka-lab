...
public class EventServiceTest {
	...
	public static final Logger LOG = LoggerFactory.getLogger(EventServiceTest.class);

	public static final int NUM_BROKERS_START = 1;
	public static final String EXAMPLE_TOPIC = "topic-events";
	...
	@Test
	public void shouldProduceEvent() throws InterruptedException {
		String result = eventService.sendEvent(TEST_MESSAGE_VALUE);
